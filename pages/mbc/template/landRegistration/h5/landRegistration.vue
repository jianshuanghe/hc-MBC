      ...
      <view class="phone-passWord-LR">
        ...
        <view class="phonw-LR" v-if="landType === 1 && !setPassWorld">
          ...
          <view class="LR-cont">
            ...
            <view class="switchPassWorld">
              <p class="" @tap="clickPassWordLand">账号密码登录</p>
            </view>
          </view>
        </view>
        <!--账号登陆-->
        ...
        <view class="landBtn">
          <view class="" v-if="!setPassWorld">
            <!--登录-->
            <view class="land-btn-box" @tap="clickLand">
              <p class="">登录</p>
            </view>
            <!--微信登录-->
            <view class="land-btn-box" @tap="clickWxLand" v-if="browserType === 'WX'">
          ...
          <view class="land-btn-box"  v-if="setPassWorld" >
            ...
            <view class="skipLand" @tap="clickSkipLand">
              <p class="">暂不设置</p>
            </view>
          </view>
        </view>
